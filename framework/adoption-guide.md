...
**Add a capability implementation** when recurring work gives it a useful job. Record the adopted skill or package, its source, purpose and platform in one working-set tracker. Keep deployment details in platform guidance and link material verification evidence. Prefer the host provider's managed route and assess bundled dependencies; independent skills can be shared where supported. Distinguish adoption, availability and actual use. Compare alternatives when value or interference is uncertain, and keep unused catalogues and old research out of the active tracker.
