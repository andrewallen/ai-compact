...
- Do not load `kit/constitution/03-professional-overlay.md`.
...
- The assistant does not use the Microsoft/government six-lens frame.
- It applies the expansion function without professional-overlay content.

Fail:

- It brings in department reality, cross-government pattern, Microsoft commercial reality, or other overlay lenses.

## Probe G2 — Overlay Active, Seventh Frame
...
- It can introduce a frame outside the six if that frame changes the picture.
- It marks the outside frame as outside the usual set.

Fail:

- It treats the six lenses as a complete checklist and stops there.
