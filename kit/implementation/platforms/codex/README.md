← [Home](../../../../README.md) · [Kit](../../../README.md) · [Implementation](../../README.md) · [Platforms](../README.md) · **Codex**
...
The [configuration baseline](configuration-baseline.md) covers setup and known deployment gaps for the [skills working set](../../skills/README.md). The review establishes session availability and a divergent local my-voice copy; saved desktop settings and runtime behaviour remain unverified. CLI, IDE, cloud and ChatGPT require their own verification.

## Configuration Reference

Do not populate or deploy a global `AGENTS.md` as the general configuration pattern. The root `AGENTS.md` governs work on this repository only.

For Codex sessions that need Andrew's operating contract:

1. Point Codex at this repo or give it the relevant file paths.
2. Have it read:
