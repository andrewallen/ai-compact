...
The [configuration baseline](configuration-baseline.md) owns current deployment observations and remaining gaps for the [skills working set](../../skills/README.md). Source-file identity, saved desktop settings and runtime behaviour are separate claims. CLI, IDE, cloud and ChatGPT require their own verification.
