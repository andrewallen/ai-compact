...
| Personal output | The selected base plus `my-voice` when available and relevant. Its craft does not style thinking dialogue. |
...
| Calibration: identity and thinking context | Compressed: role, experience and systems thinking | Omitted: name only | Career, personal thinking moves and professional background require calibration when useful; task handover supplies relevant context. |
...
| Expansion and challenge | Compressed | Compressed | Consequential lenses, active scrutiny, material pause and no manufactured objections retained; detailed trigger catalogue and candidate-generation mechanics shortened. |
...
| My Voice | Compressed | Compressed | Owned positions versus neutral factual documentation, British English, facts/caveats and durable vocabulary bans retained. Narrative craft, audience detail and unavailable-skill handling require full core or the skill. |
