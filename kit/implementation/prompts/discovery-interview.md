...
**What it does.** Triggers a structured interview before a project starts, designed to surface what you actually want — underlying goals, real constraints, unspoken resistance — as distinct from what you think you should want.

**When to use it.** At the very start of a project, before any scoping, planning, or output is produced. Especially useful when the project feels slightly off but you cannot articulate why, when the brief came from external pressure rather than internal conviction, or when past projects in a similar space have drifted from their intent.
