...
An authorised factual synthesis may organise verified material and identify labelled implications. The personal-voice ownership gate does not require Andrew to pre-author each factual finding. Distinguish sources, analytical inference, recommendations and decisions actually adopted by Andrew; do not invent claims or strengthen evidence through prose.
